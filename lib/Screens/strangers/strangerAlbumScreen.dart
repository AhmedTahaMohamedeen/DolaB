...
class StrangerAlbumScreen extends StatefulWidget {
  static const  String route='/AdminAlbumScreen';
  final List<Product> products;
  final Admin admin;
  final String category;
  const StrangerAlbumScreen({Key? key, required this.admin, required this.products, required this.category}) : super(key: key);

  @override
  _StrangerAlbumScreenState createState() => _StrangerAlbumScreenState();
}

class _StrangerAlbumScreenState extends State<StrangerAlbumScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        elevation: 0,
        title: Text(widget.category,style: TextStyle(color: Theme.of(context).appBarTheme.titleTextStyle!.color),),
      ),
            ...
            return Stack(
              children: [
                widget.products.length==0
                    ?
                Center(child: Text('فارغ',style: TextStyle(color: Theme.of(context).textTheme.bodySmall!.color)),)
                    ...
                    SliverPadding(
                      ...
                      SliverGrid(
                        ...
                        SliverChildBuilderDelegate(
                            ...
                            return   StrangerProductItem(product: widget.products[index], admin:Admin());
                          },
                ...
                MyFloating(myLoc1: myLoc.none,floatingColor: Theme.of(context).scaffoldBackgroundColor,)
...
class StrangerProductItem extends StatefulWidget {

  final Product product;
  final Admin admin;
  const StrangerProductItem({
    Key? key,
  ...
  @override
  _StrangerProductItemState createState() => _StrangerProductItemState();
}
class _StrangerProductItemState extends State<StrangerProductItem> {
  //var count=0;
  //bool liked=false;
