import 'package:adminappp/Screens/beginningScreens/verify3.dart';
...
class VerifyScreen2 extends StatefulWidget {
  static const  String route='/VerifyScreen2';

  const VerifyScreen2({Key? key}) : super(key: key);

  @override
  _VerifyScreen2State createState() => _VerifyScreen2State();
}

class _VerifyScreen2State extends State<VerifyScreen2> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: color_bl,
        title: Text('Step-2',style: TextStyle(color: color_y),
        ),
      ),
