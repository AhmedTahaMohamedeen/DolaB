...
import 'package:adminappp/Screens/beginningScreens/phoneLogin.dart';
import 'package:adminappp/constants/constantss.dart';
import 'package:adminappp/providers/authProvider.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class RegisterChoosesScreen extends StatefulWidget {
  static const  String route='/RegisterChoosesScreen';

  const RegisterChoosesScreen({Key? key}) : super(key: key);
  @override
  _RegisterChoosesScreenState createState() => _RegisterChoosesScreenState();
}

class _RegisterChoosesScreenState extends State<RegisterChoosesScreen> {
  @override
              ...
              child: SizedBox(
                ...
                child: Column(
                        ...
                        child: Stack(
                          children: [
                            Container(
                              ...
                              child:const  Center(child: Text('register with Email',style: TextStyle(color: Colors.white),)),
                  ...
                  /*  InkWell(
                    ...
                    InkWell(
                        onTap: ()async{
                         Navigator.pushNamed(context, PhoneLogin.route);
